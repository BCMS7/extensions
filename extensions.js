...
(async function () {
  ...
  "-Added detection of a niche error related to the latest version chrome, and a warning in local chat when it happens.";
  ...
  const selfmenuanchor = [70, 968, 30, 10];
  ...
  function ActionBeep(tar, str1,str2){
    ServerSend("ChatRoomChat", { Content: "Beep", Type: "Action", Dictionary: [{Tag: "Beep", Text: nameornickname(Player) + str1 + nameornickname(tar) + str2}]});
  }
